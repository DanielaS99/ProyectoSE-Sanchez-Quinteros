...
#define ACK_VAL    0x0         //Valor de confirmacion de mensaje recibido  
#define NACK_VAL   0x1         //Valor de confirmacion de no recepcion de mensaje  
...
/**
 * @brief //Funcion que dara la senal al sistema para empezar a trabajar. 
 * Dentro de este bloque se llama a la funcion mpu6050_myinit() para inicializar el sensor MPU6050. 
 * Luego, se inicia el bucle while(1), el cual hara que el sistema trabaje mientras el circuito 
 * se encuentre encendido, dentro de este bloque while se llamara la funcion getData() para imprimir 
 * por la terminal serial los valores leidos por el sensor
 */
void app_main(void)
{
     mpu6050_myinit(); 
